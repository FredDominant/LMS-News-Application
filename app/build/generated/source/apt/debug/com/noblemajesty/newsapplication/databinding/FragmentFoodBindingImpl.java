...
public class FragmentFoodBindingImpl extends FragmentFoodBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.foodSwipeRefresh, 2);
        sViewsWithIds.put(R.id.foodRecyclerView, 3);
    }
    // views
    // variables
    // values
    ...
    public FragmentFoodBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private FragmentFoodBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.newsFragmentContainer.setTag(null);
