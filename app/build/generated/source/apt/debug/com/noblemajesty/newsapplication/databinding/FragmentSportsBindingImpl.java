...
public class FragmentSportsBindingImpl extends FragmentSportsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.sportsSwipeRefresh, 2);
        sViewsWithIds.put(R.id.sportsRecyclerView, 3);
    }
    // views
    // variables
    // values
    ...
    public FragmentSportsBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private FragmentSportsBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.sportsFragmentContainer.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
